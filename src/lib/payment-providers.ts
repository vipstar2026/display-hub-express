...
export const PAYMENT_PROVIDERS: PaymentProvider[] = [
  ...
  },
  {
    ...
    currencies: ["BHD"],
    fields: [
      { key: "terminal_id", label_ar: "Terminal ID", label_en: "Terminal ID", required: true },
      { key: "password", label_ar: "كلمة مرور الطرفية", label_en: "Terminal password", kind: "password", required: true },
      { key: "secret_key", label_ar: "المفتاح السري (Resource key)", label_en: "Secret / resource key", kind: "password", required: true },
      { key: "merchant_id", label_ar: "رقم التاجر", label_en: "Merchant ID" },
    ],
    steps_ar: [
      "قدّم طلب تاجر عبر بنكك في البحرين للحصول على حساب BENEFIT BPG.",
      "ستصلك رسالة تحتوي Terminal ID وكلمة المرور والمفتاح السري.",
    ...
    steps_en: [
      ...
      "You will receive Terminal ID, password and the resource key.",
