...
export const PAYMENT_PROVIDERS: PaymentProvider[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "brands", label_ar: "البطاقات المسموحة", label_en: "Allowed card brands", placeholder: "VISA MASTER BENEFIT AMEX MADA",
        hint_ar: "افصل بمسافة. اكتب فقط البطاقات المفعّلة في عقدك مع AFS — أي علامة غير مفعّلة ستُرفض عند الدفع. الشائع: VISA MASTER BENEFIT.",
        hint_en: "Space separated. List only the brands enabled in your AFS contract — a non-enabled brand is rejected at payment. Common: VISA MASTER BENEFIT." },
