...
export function Footer() {
  const { t } = useI18n();
  return (
    <footer className="mt-20 border-t border-primary/20 bg-card/30 py-10">
      <div className="container mx-auto px-4 text-center">
        <div className="mb-3 flex items-center justify-center gap-2 font-display text-lg font-bold text-primary">
