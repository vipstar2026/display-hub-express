  ...
  const groups: { label: string; items: { to: string; icon: typeof LayoutDashboard; label: string; exact?: boolean; badge?: number }[] }[] = [
...

    {
      ...
      items: [
        ...
        { to: "/admin/analytics", icon: Activity, label: t("admin.analytics") },
        { to: "/admin/coupons", icon: Ticket, label: t("admin.coupons") },
        { to: "/admin/coupon-usage", icon: Ticket, label: t("admin.coupon_usage") },
        { to: "/admin/flash-sales", icon: Zap, label: t("admin.flash_sales") },
    ...
    },
    {
      ...
      items: [
        ...
        { to: "/admin/suppliers", icon: Truck, label: t("admin.suppliers") },
        { to: "/admin/purchase-orders", icon: FileText, label: t("admin.purchase_orders") },
        { to: "/admin/reviews", icon: MessageSquare, label: t("admin.reviews") },
      ],
    },

    {
      ...
      items: [
        { to: "/admin/banners", icon: ImageIcon, label: t("admin.banners") },
        { to: "/admin/blog", icon: Newspaper, label: t("admin.blog") },
        { to: "/admin/messages", icon: MessageSquare, label: t("admin.messages"), badge: unreadMsgs },
        { to: "/admin/emails", icon: Mail, label: t("admin.outbox") },

        { to: "/admin/newsletter", icon: Mail, label: t("admin.newsletter") },
        { to: "/admin/campaigns", icon: Megaphone, label: t("admin.campaigns") },
